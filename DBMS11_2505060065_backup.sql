...
--
-- Host: localhost    Database: DBMS11_2505060065
-- ------------------------------------------------------
...
CREATE TABLE `tbpegawai` (
  ...
  PRIMARY KEY (`nip`),
  KEY `fk_pegawai_gaji` (`gol`),
  CONSTRAINT `fk_pegawai_gaji` FOREIGN KEY (`gol`) REFERENCES `tbgaji` (`Gol`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-04-07 21:06:01
